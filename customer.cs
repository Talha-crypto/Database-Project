...
namespace SplashScreen
{
    ...
    {
        readonly string connectionString = "Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename='C:\\Users\\Republic\\Downloads\\Project\\Pharmacy Managenent System\\PharmacyDatabase2.mdf';Integrated Security=True";
        SqlConnection newConnection;
        public customer()
        {
            InitializeComponent();
            using (SqlConnection cnn = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename='C: \Users\Republic\Downloads\Project\Pharmacy Managenent System\PharmacyDatabase2.mdf';Integrated Security=True"))
            {
